...
const TestimonialsPage = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 5,
      timeAgo: "a week ago",
      review: "Every appointment was on time, and the spirometry tests were explained in detail. Dr. Telbhare's 18+ years of experience really shows in his confident diagnosis. We truly appreciate the professionalism.",
      verified: true,
      hasResponse: true,
