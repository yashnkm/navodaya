        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/917507468918?text=Hi%20Navodaya%20Chest%20Care,%20I%20would%20like%20to%20book%20an%20appointment" target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center justify-center gap-2">
